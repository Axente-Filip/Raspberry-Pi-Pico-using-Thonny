...
# AUTO ACKNOWLEDGMENT
EN_AA = const(0x01)  # Auto Acknowledgment Register
...
class NRF24L01:
    ...
    def set_auto_ack(self, enable=True):
        if enable:
            self.reg_write(EN_AA, 0b111111)  # Enable auto acknowledgment on all pipes
        else:
            self.reg_write(EN_AA, 0x00)  # Disable auto acknowledgment
